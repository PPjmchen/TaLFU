...
def parameters():
    ...
    params.max_image_sample_size = (26*16)**2   # Maximum image sample size
    params.min_image_sample_size = (26*16)**2   # Minimum image sample size
    params.search_area_scale = 8                # Scale relative to target size
    ...
    deep_params.output_sigma_factor = 1/2           # Standard deviation of Gaussian label relative to target size
